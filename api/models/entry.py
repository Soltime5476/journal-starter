...
class EntryCreate(BaseModel):
    ...
    work: Annotated[str, StringConstraints(strip_whitespace=True, min_length=1)] = Field(
        max_length=256,
        description="What did you work on today?",
        json_schema_extra={"example": "Studied FastAPI and built my first API endpoints"},
    )
    struggle: Annotated[str, StringConstraints(strip_whitespace=True, min_length=1)] = Field(
        max_length=256,
        description="What's one thing you struggled with today?",
        json_schema_extra={"example": "Understanding async/await syntax and when to use it"},
    )
    intention: Annotated[str, StringConstraints(strip_whitespace=True, min_length=1)] = Field(
        max_length=256,
...
class EntryUpdate(BaseModel):
    work: Annotated[str, StringConstraints(strip_whitespace=True, min_length=1)] | None = Field(
        default=None,
        max_length=256,
        description="What did you work on today?",
        json_schema_extra={"example": "Studied FastAPI and built my first API endpoints"},
    )
    struggle: Annotated[str, StringConstraints(strip_whitespace=True, min_length=1)] | None = Field(
        default=None,
        max_length=256,
        description="What's one thing you struggled with today?",
        json_schema_extra={"example": "Understanding async/await syntax and when to use it"},
    )
    intention: Annotated[str, StringConstraints(strip_whitespace=True, min_length=1)] | None = (
        Field(
            default=None,
            max_length=256,
            description="What will you study/work on tomorrow?",
